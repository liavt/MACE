...
TEST_CASE("Testing macros","[system][utility][preprocessor]") {
...
TEST_CASE("Conditionals", "[system][utility][preprocessor]") {
...
TEST_CASE("Testing #error", "[system][utility][preprocessor]") {
