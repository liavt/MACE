...
\subsubsection[{\texorpdfstring{floor(double value)}{floor(double value)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf int} mc\+::\+Math\+::floor (
...
\subsubsection[{\texorpdfstring{next\+Digit\+Of2(int n)}{nextDigitOf2(int n)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf int} mc\+::\+Math\+::next\+Digit\+Of2 (
\begin{DoxyParamCaption}
\item[{{\bf int}}]{n}
\end{DoxyParamCaption}
